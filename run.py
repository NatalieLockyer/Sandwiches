...
def get_sales_data():
    ...
    by commas. The loop will repeatedly reqeuest date until it is valid.
    """
    while True:
...
def calculate_surplus_data(sales_row):
    ...
    The surplus is defined as the sales figure subtracked from the stock:
    - Positive surplus indicates waste
    - Negative surplus indicates extra made as stock was sold out
    """
...
def get_last_5_entries_sales():
    ...
    the last 5 entries for each sandwich and returns the dat
    as a list of lists
    """
